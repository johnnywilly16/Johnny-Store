...
import { FaSearch, FaStar, FaHeart, FaShoppingCart, FaArrowRight, FaCheck } from 'react-icons/fa'
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                <motion.button
                  ...
                  className={`p-2 border-2 rounded-xl font-semibold transition-all duration-300 ${
