              ...
              <div className="grid sm:grid-cols-2 gap-6 sm:gap-8 p-4 sm:p-6">
                <div className="space-y-4 sm:space-y-6">
                  <div className="relative group">
                    ...
                    <motion.button
                      ...
                      className={`absolute top-4 right-4 p-2 sm:p-3 rounded-full shadow-soft ${
                        productIsFavorite
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <motion.button
                    ...
                    disabled={isInCart}
                    className={`w-full py-3 sm:py-4 rounded-xl font-semibold flex items-center justify-center gap-2 transition-colors text-sm sm:text-base ${
                      isInCart
